...
\section
{\textbf{Pebble Products LLC} \newline
Founder}{}

\vspace{-2.0ex}
\begin{detail}
    \BulletItem
    Develop/prototytpe new hardware/software products
    \BulletItem
...
{\vspace{1.0ex} \color{blue} \small \href{https://notes.abgup.com}{notes.abgup.com}}

{\vspace{-2.5ex} \hspace{3.17in} \color{blue} \small \href{https://pebbleproducts.com}{pebbleproducts.com} }
\vspace{2.5ex}
...
\section
{\textbf{Bishop Blanchet High School} \newline
CS \& Robotics Teacher}{}

\vspace{-2.0ex}
\begin{detail}
    \BulletItem
    Teach high school students engineering skills to design/build a autonomous robot
    \BulletItem
    Teach computer science in Python for Rainier Scholars
\end{detail}
...
{\vspace{0.5ex} \color{cyan} \small {Java || Python}}

{\vspace{-2.5ex} \hspace{3.17in} \color{cyan} \small {OnShape} }
\vspace{2.5ex}
...
{\vspace{2.5ex} \color{cyan}\small {AS - Domain Specific Language}}
\vspace{2.5ex}
...
{\vspace{4.5ex} \color{cyan}\small {C\# || Figma}}
...
\begin{detail}
    ...
    \BulletItem
    Developed HMI software and tested HW/SW in a clean room environment via systematic approach
    \BulletItem
